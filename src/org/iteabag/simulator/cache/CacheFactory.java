...
import org.iteabag.simulator.cache.impl.LeastRecentlyUsedCache;
...
public class CacheFactory {
    ...
    public static Cache lruCache(final Storeable<Key, Value> cache, final Storeable<Key, Value> background,
            final String name) {
        return new LeastRecentlyUsedCache(cache, background, name);
    }
